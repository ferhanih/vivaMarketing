...
import { makeSimpleRequest, makeAuthenticatedRequest, API_URL } from "../../services/Requests.tsx";
...
export default function DetailProduct() {
    ...
    const AddToCart = async () => {
        try {
            ...
            console.log("failed to add product to the cart: ", error);
            setErrors({ general: "Failed to add the product to the cart" });
        } finally {
            setLoading(false);
        }
    }
    ...
    const handleAddCart = async () => {
        if (authService.isAuthenticated()){
           ...
           console.log("Product added to the cart.")
            ...
            console.log("You cannot add product to the cart if not logged.")
        }
    }
